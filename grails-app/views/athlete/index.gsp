		...
		<div id="list-athlete" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="city" title="${message(code: 'athlete.city.label', default: 'City')}" />
				...
				<g:each in="${athleteInstanceList}" status="i" var="athleteInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${athleteInstance.id}">${fieldValue(bean: athleteInstance, field: "birthday")}</g:link></td>
