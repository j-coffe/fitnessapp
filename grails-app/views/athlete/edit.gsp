...
<html>
	...
	<body>
		<a href="#edit-athlete" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-athlete" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:athleteInstance, action:'update']" method="PUT" >
				...
				<fieldset class="buttons">
					<g:actionSubmit class="save" action="update" value="Принять" />
				</fieldset>
			</g:form>
		</div>
	</body>
